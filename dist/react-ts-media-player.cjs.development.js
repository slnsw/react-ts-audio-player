...
var AudioPlayer = function AudioPlayer(_ref) {
  ...
  var _React$useState0 = React.useState(null),
  ...
  var handleRemoteAction = React.useCallback(function (action, timestamp) {
    if (timestamp === void 0) {
      timestamp = 0;
    }
    if (action === 'backward') {
  ...
  var audioTag = /*#__PURE__*/React.createElement("audio", {
    ...
    type: "audio/mpeg"
  }), currentFile && hasVtt(currentFile) && (/*#__PURE__*/React.createElement("track", {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Time elapsed"), /*#__PURE__*/React.createElement("input", {
    className: CssClasses('video-controls', className, 'time-elapsed'),
    id: timeIndicatorId,
    readOnly: true,
    ref: timeElapsedElem,
    value: getTimestampString(timestamp)
  }), config.showDuration && (/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", {
    className: "sr-only",
    ...
    config: config
  }, "Tracklist"), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Previous track"), /*#__PURE__*/React.createElement(ActionButton, {
    btnType: "backward",
    ...
    config: config,
    ariaControls: id + "__player"
  }, playing ? 'Pause' : 'Play'), /*#__PURE__*/React.createElement(ActionButton, {
    btnType: "reset",
    enabled: ended,
    hidden: !ended,
    ...
    config: config,
    ariaControls: id + "__player"
  }, "Fast forward"), /*#__PURE__*/React.createElement(ActionButton, {
    btnType: "next-audio",
    enabled: fileData.length > 1 && canPlayNext,
    onClick: nextTrackAction,
    config: config,
    ariaControls: id + "__player"
  }, "Next track"), /*#__PURE__*/React.createElement(ToggleButton, {
    ...
    config: config
  }, "Closed captioning"), /*#__PURE__*/React.createElement("div", {
    className: CssClasses('video-controls', className, 'button-wrapper__space')
  }), /*#__PURE__*/React.createElement(ToggleButton, {
    btnType: "mute",
    ...
    config: config,
    ariaControls: id + "__player"
  }, "Mute"))), /*#__PURE__*/React.createElement(SubtitleMenu, {
    visible: showSubtitleMenu,
    id: subtitleMenuId,
    tracks: subtitleTracks(),
    selected: selectedLanguage,
    onSelect: selectSubtitleLanguage
  }), /*#__PURE__*/React.createElement(TracklistMenu, {
  ...
  }), /*#__PURE__*/React.createElement(SubtitleContainer, {
...
exports.DEFAULT_PLAYER_STATE = DEFAULT_PLAYER_STATE;
exports.PlayerRemoteProvider = PlayerRemoteProvider;
exports.default = AudioPlayer;
exports.defaultConfigs = defaultConfigs;
exports.usePlayerRemote = usePlayerRemote;
exports.usePlayerRemoteById = usePlayerRemoteById;
